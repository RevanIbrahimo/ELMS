...
{
    public partial class ContractUserControl : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        {
            OrderGridControl.DataSource = OrderDAL.SelectContractData(2,5,6);
        ...
        void UpdateConfirm()
        {
            LoadFConfirmAddEdit(TransactionTypeEnum.Update,UserControlTypeEnum.Contract, orderID);
        }
